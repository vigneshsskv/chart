...
class MarkerOptions {
  ...
  List<PaintOptions> get paintList => [paint];
...
class MarkerShapes {
  ...
  static const List<MarkerShape> all = [
    circle,
    square,
    plus,
    x,
  ...
  static const MarkerShape square = SquareMarkerShape();

  static const MarkerShape plus = PlusMarkerShape();

  static const MarkerShape x = XMarkerShape();

  static const MarkerShape star = StarMarkerShape();

  static const MarkerShape star6 = StarMarkerShape(spikes: 6);

  static const MarkerShape star8 = StarMarkerShape(spikes: 8);

  static const MarkerShape star12 = StarMarkerShape(spikes: 12);

  static const MarkerShape triangle = StarMarkerShape(
    spikes: 3,
    inset: 1 / 2,
  );

  static const MarkerShape pentagon = StarMarkerShape(
    spikes: 5,
    inset: 1 / 5,
  );

  static const MarkerShape hexagon = StarMarkerShape(
    spikes: 6,
    inset: 1 / 6,
  );

  /// A horizontal line with respect to the chart direction.
  static const MarkerShape horizontalLine = LineMarkerShape();

  /// A vertical line with respect to the chart direction.
  static const MarkerShape verticalLine = LineMarkerShape(vertical: true);
}
...
class CircleMarkerShape implements MarkerShape {
  ...
  void draw(CanvasArea area, List<PaintOptions>? paints) {
    ...
    for (final paint in paints) {
      area.drawArc(area.full, 0.0, 2 * pi, paint);
    }
  }
}
