...
class CanvasArea {
  ...
  const CanvasArea.fromCanvas(this.canvas, Size size)
  ...
  Rect boundRect(Rect rect) =>
      Rect.fromPoints(boundPoint(rect.topLeft), boundPoint(rect.bottomRight));
...
typedef PaintGenerator = List<PaintOptions> Function(CanvasArea area);
